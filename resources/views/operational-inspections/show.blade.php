            ...
            <div class="card h-100">
                ...
                <div class="card-body p-4">
                    <dl class="row mb-0">
                        ...
                        <dd class="col-sm-7 mb-2">{{ optional($inspection->vehicle)->registration_number }} -
                            {{ optional($inspection->vehicle)->model }}</dd>
                        <dt class="col-sm-5 mb-2">Sopir</dt>
                        <dd class="col-sm-7 mb-2">{{ optional($inspection->driver)->name }}</dd>
