    ...
    <div class="card-body">
        <form method="GET" class="row g-3">
            ...
            <div class="col-md-3">
                ...
                <input type="text" name="vehicle_id" value="{{ request('vehicle_id') }}" class="form-control" placeholder="ID kendaraan">
            </div>
        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle">
                ...
                <tbody>
                            ...
                            @if(auth()->user()->isAdmin() || auth()->user()->isSopir())
                                <td>
                                    <div class="btn-group" role="group">
                                        <a href="{{ route('inspections.show', $inspection) }}" class="btn btn-sm btn-info" title="Lihat detail">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="{{ route('inspections.edit', $inspection) }}" class="btn btn-sm btn-secondary" title="Edit laporan">
                    ...
                    @empty
                        <tr>
                            <td colspan="{{ auth()->user()->isAdmin() || auth()->user()->isSopir() ? 8 : 7 }}" class="text-center text-muted py-4">Belum ada data pemeriksaan operasional.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
